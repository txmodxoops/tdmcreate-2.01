...
$modversion['tables'][$i] = 'tdmcreate_import'; $i++;
...
$i++;
$modversion['config'][$i]['name'] = 'author_website';
...
$modversion['config'][$i]['default'] = 0;
$i++;
$modversion['config'][$i]['name'] = 'release';
...
$i++;
$modversion['config'][$i]['name'] = 'paypal_button';
$modversion['config'][$i]['title'] = TDMCreateLocale::CONF_PAYPAL_BUTTON;
$modversion['config'][$i]['description'] = '';
$modversion['config'][$i]['formtype'] = 'textbox';
$modversion['config'][$i]['valuetype'] = 'text';
...
$modversion['config'][$i]['formtype'] = 'textbox';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = '12560';
unset($i);